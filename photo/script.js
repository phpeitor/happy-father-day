...
function startImageInterval() {
  ...
  intervalId = setInterval(() => {
    ...
    randomElement.addEventListener('click', (evt) => { 
      evt.stopPropagation();
      console.log('foto clicada:', randomElement.style.background);
      ...
      img.className = 'lightbox-img';
        ...
        // Copiar y ajustar el background de la imagen seleccionada (más robusto)
        let computedBg = '';
        try {
          computedBg = getComputedStyle(randomElement).backgroundImage || '';
        } catch (e) {
          computedBg = randomElement.style.background || '';
        }
        // Si viene como "url('...')" está bien para backgroundImage
        if (computedBg && computedBg !== 'none') {
          img.style.backgroundImage = computedBg;
        } else if (randomElement.style.background) {
      ...
      // Cerrar solo cuando se clickea fuera de la imagen o en la X
      ...
      // evitar que el click dentro de la imagen cierre inmediatamente
